...
WebUI.verifyElementPresent(findTestObject('Add Tags/Message empty name'), 5)

WebUI.verifyElementText(findTestObject('Add Tags/Message empty name'), 'タグ名を入力してください。')
